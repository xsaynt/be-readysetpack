    ...
    return connection_1.default
      ...
      `);
        ...
        if (usersData.length > 0) {
          ...
          VALUES %L;
        `, userValues);
            userPromises.push(connection_1.default.query(insertUsersQueryStr));
        }
        const costPromises = [];
        if (costsData.length > 0) {
          ...
          VALUES %L;
        `, costValues);
            costPromises.push(connection_1.default.query(insertDailyCostQueryStr));
        }
        ...
        `, tripValues);
            tripPromises.push(connection_1.default.query(insertTripsQueryStr));
        }
        ...
        if (checklistData.length > 0) {
          ...
          VALUES %L;
        `, checklistValues);
            checklistPromises.push(connection_1.default.query(insertChecklistQueryStr));
        }
